// ============================================================================
// Směnářek 1.8.1 – KOMPLETNÍ FULL VERZE (Hanuman Edition)
// ============================================================================
...
function updateStats() {
    ...
    let dDay = 0, nDay = 0, vac = 0, hours = 0, nightH = 0, afterH = 0, weekendH = 0, holWorkedH = 0, rDays = 0, oDays = 0;
...
function calcPay() {
    ...
    if ($('pay')) {
        $('pay').innerHTML = [
            ...
            ['Příplatek přesčas (25%)', money(otExtraPay)],
